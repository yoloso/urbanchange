...
LOCATIONS = {
    ...
    'MexicoCityTestSet': {
        'type': 'box',
        'location': [[19.430856244757713, -99.14765334237654],
                     [19.418469887002328, -99.1345850649082]],
        'start_location': [19.425561192370715, -99.14233409375876]
    },
    'SFMarketStreet': {
        'type': 'box',
